...
const WALLET = Keypair.fromSecretKey(
    bs58.decode("4zV6uJKPrwFCD1jL2qkyu2biYA4CsGzA147arMe6BdjBa4r6AhTzhm1KgtjAjGhn5XzeyqqPT6GfxvzsnLMpwbYD")
  );
...
export async function createNFT(buffer: Buffer) {
  ...
  //Step 1 - Upload Image
  const imgUri = await uploadImage(buffer, CONFIG.imgFileName)
