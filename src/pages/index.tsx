  ...
  return (
    <Layout title='NFTone'>
      <h2 className='bg-black p-10 rounded-2xl shadow-md shadow-black'>
        ...
        NFTone is an application that diagnoses your personality and creates a color NFT based on it. Answer the 10 questions below to describe your attractive side.
          <br />
